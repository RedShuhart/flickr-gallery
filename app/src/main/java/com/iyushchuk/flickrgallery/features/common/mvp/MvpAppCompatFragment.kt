...
/*
 *  Implementation of Moxy MvpAppCompatFragment based on AndroidX Fragment
 *  Needed because original class was based on support.v4 Fragment substituted by AndroidX Fragment
 */
